...
[Materials]
  ...
  [./system_constants]
    ...
    prop_values = '1.8e-15 2.3e-15 1e-8 25 0.25 0.6 0.7e-11 0.7e-12 1e7 1.19'
  [../]
  # [./material_constants]
  #   type = GenericConstantMaterial
  ...
  [./free_energy_fs]
    ...
    derivative_order = 2
    outputs = exodus  
    constant_names = 'A B B_etas B_phis B_eta_phis'
    constant_expressions = '1 1e3 0.25 0.2 5'
    expression = 'A*c^2*(1-c)^2+B_etas*eta^2*(1-eta)^2 + B_phis*phi^2*(1-phi)^2+ B_eta_phis*eta^2*phi^2'
  [../]
  [./free_energy_fl]
    type = DerivativeParsedMaterial
    property_name = fl
    ...
    derivative_order = 2
    outputs = exodus
    constant_names = 'A B B_eta B_phi B_eta_phi'
    constant_expressions = '0.2 2e3 0.25 0.2 5'

    expression = '
      A*c^2*(1-c)^2
      +
      B_eta*eta^2*(1-eta)^2 + B_phi*phi^2*(1-phi)^2+ B_eta_phi*eta^2*phi^2  
    '
  [../]
  [./free_energy]
  ...
  #   derivative_order = 2
  #   outputs = exodus
  #   constant_names = 'A B Weta Wphi Ac'
  #   constant_expressions = '1.0 2e3 0.25 0.25 3'
...
[Outputs]
  ...
  file_base = results/solidchange48/phi0test48
