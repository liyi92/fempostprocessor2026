...
[Materials]
  ...
  [./free_energy_fs]
    ...
    constant_expressions = '1364 0.25 0.25 5.5'

    expression = '
     As*(c-0.4)^2+B_eta*eta^2*(1-eta)^2 + B_phi*phi^2*(1-phi)^2+ B_eta_phi*eta^2*phi^2
  ...
  [./free_energy_fl]
    ...
    expression = '
     Al*(c-0.6)^2+B_eta*eta^2*(1-eta)^2 + B_phi*phi^2*(1-phi)^2+ B_eta_phi*eta^2*phi^2
...
[Outputs]
  ...
  file_base = results/solidchangephitest4/phi0test1
[]
